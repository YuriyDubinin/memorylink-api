...
namespace utils::security {
    ...
    std::string
    encrypt(const std::string& plaintext, const std::string& key, const std::string& salt) {
    ...
    std::string
    decrypt(const std::string& hex_input, const std::string& key, const std::string& salt) {
