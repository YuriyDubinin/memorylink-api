...
// #define CONFIGURE_ARGS " '--without-icu' '--with-lz4' '--without-nls' '--with-openssl' '--without-readline' '--without-xml' '--without-xslt' '--with-zlib' '--without-zstd' 'PG_SYSROOT=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/Users/yuriy/Documents/Projects/memorylink/memorylink-api/build/vcpkg_installed/arm64-osx' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/cc -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk -fPIC -g -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk -DNDEBUG -fPIC -O3' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/Users/yuriy/Documents/Projects/memorylink/memorylink-api/build/vcpkg_installed/arm64-osx/lib -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk' 'CPPFLAGS=-isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX15.5.sdk -DNDEBUG' 'CXX=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/opt/homebrew/bin/pkg-config' 'PKG_CONFIG_PATH=/Users/yuriy/Documents/Projects/memorylink/memorylink-api/vcpkg/packages/libpq_arm64-osx/lib/pkgconfig:/Users/yuriy/Documents/Projects/memorylink/memorylink-api/vcpkg/packages/libpq_arm64-osx/share/pkgconfig:/Users/yuriy/Documents/Projects/memorylink/memorylink-api/build/vcpkg_installed/arm64-osx/lib/pkgconfig:/Users/yuriy/Documents/Projects/memorylink/memorylink-api/build/vcpkg_installed/arm64-osx/share/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.9 on aarch64-apple-darwin25.1.0, compiled by Apple clang version 17.0.0 (clang-1700.0.13.5), 64-bit"
